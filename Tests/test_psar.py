...
class TestPSAR(unittest.TestCase):
    ...
    def test_psar(self):
        ...
        self.assertEqual(
            round(self.result_psar[0], 2), round(self.result.parabolic_sar()[0], 2)
        )
        self.assertEqual(
            round(self.result_psar[2], 2), round(self.result.parabolic_sar()[2], 2)
        )
        self.assertEqual(
            round(self.result_psar[-1], 2), round(self.result.parabolic_sar()[-1], 2)
        )
