...
class testDX(unittest.TestCase):
    ...
    def test_plus_dm(self):
        ...
        self.assertAlmostEqual(
            self.plus_dm_result[self.fix1_number], self.data["+DM 1"][self.fix1_number]
        )
    ...
    def test_minus_dm(self):
        ...
        self.assertAlmostEqual(
            self.minus_dm_result[self.fix1_number], self.data["-DM 1"][self.fix1_number]
        )
    ...
    def test_smoothed_plus_dm14(self):
        ...
        self.assertAlmostEqual(
            self.smoothed_plus_dm14_result[self.fix2_number],
            self.data["+DM14"][self.fix2_number],
        )
    ...
    def test_smoothed_minus_dm14(self):
        ...
        self.assertAlmostEqual(
            self.test_smoothed_minus_dm14_result[self.fix2_number],
            self.data["-DM14"][self.fix2_number],
        )
    ...
    def test_smoothed_tr14(self):
        ...
        self.assertAlmostEqual(
            self.test_smoothed_tr14_result[self.fix2_number],
            self.data["TR14"][self.fix2_number],
        )
    ...
    def test_plus_di_14(self):
        ...
        self.assertAlmostEqual(
            self.test_plus_di_14_result[self.fix2_number],
            self.data["+DI14"][self.fix2_number],
        )
    ...
    def test_minus_di_14(self):
        ...
        self.assertAlmostEqual(
            self.test_minus_di_14_result[self.fix2_number],
            self.data["-DI14"][self.fix2_number],
        )
    ...
    def test_di_diff(self):
        ...
        self.assertAlmostEqual(
            self.test_di_diff_result[self.fix2_number],
            self.data["DI 14 Diff"][self.fix2_number],
        )
    ...
    def test_di_sum(self):
        ...
        self.assertAlmostEqual(
            self.test_di_sum_result[self.fix2_number],
            self.data["DI 14 Sum"][self.fix2_number],
        )
    ...
    def test_dx(self):
        ...
        self.assertAlmostEqual(
            self.test_dx_result[self.fix2_number], self.data["DX"][self.fix2_number]
        )
