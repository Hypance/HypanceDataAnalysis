...
class TestCmf(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.cmf_data = MFI(self.close,self.low,self.high,self.volume)
        
    def test_typical_price(self):
        self.typical_price = self.cmf_data.typical_price()
    ...
    def test_raw_money_flow(self):
        self.raw_money_flow = self.cmf_data.raw_money_flow()
    ...
    def test_up_or_down(self):
        self.up_or_down = self.cmf_data.up_or_down()
    ...
    def test_one_period_positive_mf(self):
        self.one_period_positive_mf = self.cmf_data.one_period_positive_mf()
    ...
    def test_one_period_negative_mf(self):
        self.one_period_negative_mf = self.cmf_data.one_period_negative_mf()
    ...
    def test_positive_money_flow(self):
        self.positive_money_flow = self.cmf_data.positive_money_flow()
    ...
    def test_negative_money_flow(self):
        self.negative_money_flow = self.cmf_data.negative_money_flow()
    ...
    def test_money_ratio(self):
        self.money_ratio = self.cmf_data.money_ratio()
        self.assertAlmostEqual(self.money_ratio[23],self.data["14-period Money Flow Ratio"][23])
        self.assertIsInstance(self.money_ratio,pd.Series)

    def test_money_flow_index(self):
        self.money_flow_index = self.cmf_data.money_flow_index()
