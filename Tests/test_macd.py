...
class TestMACD(unittest.TestCase):
    ...
    def test_ema1(self):
        ...
        self.assertEqual(round(self.result_ema1[ema_value1-1],2), round(self.result.Ema_1()[0],2))
        self.assertEqual(round(self.result_ema1[ema_value1+1],2), round(self.result.Ema_1()[2],2))    
        self.assertEqual(self.result_ema1[-1], self.result.Ema_1()[-1])
        
        self.assertEqual(len(self.result_ema1)-ema_value1+1, len(self.result.Ema_1()))
    ...
    def test_ema2(self):
        ...
        self.assertEqual(round(self.result_ema2[ema_value2-1],2), round(self.result.Ema_2()[0],2))
        self.assertEqual(round(self.result_ema2[ema_value2+1],2), round(self.result.Ema_2()[2],2))    
        self.assertEqual(self.result_ema2[-1], self.result.Ema_2()[-1])
        
        self.assertEqual(len(self.result_ema2)-ema_value2+1, len(self.result.Ema_2()))
    ...
    def test_moving_average_convergence_divergence(self):
        ...
        self.assertEqual(round(self.result_macd[ema_value2-1],2), round(self.result.MovingAverageConvergenceDivergence()[0],2))
        self.assertEqual(round(self.result_macd[ema_value2+1],2), round(self.result.MovingAverageConvergenceDivergence()[2],2))    
        self.assertEqual(self.result_macd[-1], self.result.MovingAverageConvergenceDivergence()[-1])
        
        self.assertEqual(len(self.result_macd)-ema_value2+1, len(self.result.MovingAverageConvergenceDivergence()))
    ...
    def test_signal(self):
        ...
        self.assertEqual(round(self.result_signal[ema_value2+signal_value-2],2), round(self.result.Signal()[0],2))
        self.assertEqual(round(self.result_signal[ema_value2+signal_value],2), round(self.result.Signal()[2],2))    
        self.assertEqual(self.result_signal[-1], self.result.Signal()[-1])
        
        self.assertEqual(len(self.result_signal)-ema_value2-signal_value+2, len(self.result.Signal()))
    ...
    def test_histogram(self):
        ...
        self.assertEqual(round(self.result_histogram[ema_value2+signal_value-2],2), round(self.result.Histogram()[0],2))
        self.assertEqual(round(self.result_histogram[ema_value2+signal_value],2), round(self.result.Histogram()[2],2))    
        self.assertEqual(self.result_histogram[-1], self.result.Histogram()[-1])
        
        self.assertEqual(len(self.result_histogram)-ema_value2-signal_value+2, len(self.result.Histogram()))
    ...
    def test_ema1_ema2_default(self):
        ...
        self.assertEqual(len(MACD(self.close).Ema_1())-len(MACD(self.close).Ema_2()),ema_2-ema_1)
    ...
    def test_ema1_ema2_18_30(self):
        ...
        self.assertEqual(len(MACD(self.close,18,30).Ema_1())-len(MACD(self.close,18,30).Ema_2()),ema_2-ema_1)
    ...
    def test_ema2_histogram_default(self):
        ...
        self.assertEqual(len(MACD(self.close).Ema_2())-len(MACD(self.close).Histogram()),signal-1)
    ...
    def test_ema2_histogram_18_30_12(self):
        ...
        self.assertEqual(len(MACD(self.close,18,30,12).Ema_2())-len(MACD(self.close,18,30,12).Histogram()),signal-1)
